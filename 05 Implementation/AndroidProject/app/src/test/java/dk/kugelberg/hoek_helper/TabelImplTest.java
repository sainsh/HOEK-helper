...
public class TabelImplTest {
    ...
    public class DomkMock implements DOMK {
    ...
    public class KeMock implements KE {
    ...
    public class KoMock implements KO {
    ...
    public class SeMock implements SE {
    ...
    public class StoMock implements STO {
    ...
    public class VeMock implements VE {
    ...
    public class VoMock implements VO {
